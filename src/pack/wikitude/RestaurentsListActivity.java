...
public class RestaurentsListActivity extends ListActivity{
	...
	protected void onCreate( Bundle savedInstanceState ) {
		...
		Log.i("LA CLASSE ", "SamplesListActivity");
...
//		this.setContentView( this.getContentViewId() );
	...
	//	this.setTitle(this.getActivityTitle());
		...
		final Intent intent = new Intent( this, SamplePoidataFromNativeAndUrlListenerActivity.class );
		
		//intent.putExtra(EXTRAS_KEY_ACTIVITY_TITLE_STRING, this.getListLabels()[position]);
		
		
		intent.putExtra(EXTRAS_KEY_ACTIVITY_TITLE_STRING, "Tunisian Restaurants around you:");
		
		
		intent.putExtra(EXTRAS_KEY_ACTIVITY_ARCHITECT_WORLD_URL, "samples" + File.separator + "3_Restaurants_" + File.separator + "index.html");
