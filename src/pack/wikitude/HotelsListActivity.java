...
public class HotelsListActivity extends ListActivity{
...
//		this.setContentView( this.getContentViewId() );
	...
	//	this.setTitle(this.getActivityTitle());
		...
		intent.putExtra(EXTRAS_KEY_ACTIVITY_TITLE_STRING, "Tunisian Hotels around you:");
		
		
		intent.putExtra(EXTRAS_KEY_ACTIVITY_ARCHITECT_WORLD_URL, "samples" + File.separator + "2_Hotels_" + File.separator + "index.html");
