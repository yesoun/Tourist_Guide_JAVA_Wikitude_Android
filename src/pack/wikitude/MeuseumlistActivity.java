...
public class MeuseumlistActivity extends ListActivity{
...
//		this.setContentView( this.getContentViewId() );
	...
	//	this.setTitle(this.getActivityTitle());
		...
		intent.putExtra(EXTRAS_KEY_ACTIVITY_TITLE_STRING, "Tunisian Museums around you:");
		
		
		intent.putExtra(EXTRAS_KEY_ACTIVITY_ARCHITECT_WORLD_URL, "samples" + File.separator + "4_Museum_" + File.separator + "index.html");
